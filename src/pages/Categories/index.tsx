...
const promocoes: Game[] = [
  {
    ...
    category: 'Ação',
    description:
      'Resident Evil 4, conhecido no Japão com Biohazard 4, é um jogo eletrônico de survival horror...',
...
const emBreve: Game[] = [
  {
    ...
    category: 'RPG',
    description:
      'Diblo IV é um RPG de ação em desenvolvimento pela Blizzard Entertainment',
    title: 'Diablo IV',
    system: 'Windows',
    infos: ['17/05'],
    image: diablo
